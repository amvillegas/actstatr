...
The **lifecontingencies** package is the main `R` package available for performing standard financial and actuarial mathematics calculations. In this section we aim to introduce the use of this package for performing life table calculations. If you are interested in the wider use of this package please refer to Chapter 7 of the book by @Charpentier2014.

Note that the **lifecontingencies** package has been loaded in the current R workspace. Therefore you can utilise the capacities of the package without explicitly loading it.
...
**Example**. if we consider $l_0 = 120, l_1 = 119, l_2 = 118, \ldots, l_{120} = 0$, we can create a life table with the following steps:


```{r lt,cache=TRUE}
## create a life table
x <- 0:120 # create a vector Xof ages, that is, integers from 0 to 120
...
question("Can you see what distribution we are assuming for the future life time T?",
