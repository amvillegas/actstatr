...
Similarly, one can find out the value for the death probability, $_{10}q_{75}$, by using the following codes:
...
question("Which one of the following statements about lifetimes and life expectancies is **false**?",
  answer("The curtate life expectancy computes the expected value of the integer part of the lifetime.",
         message = "This statement is true. Recall that curtate life expectancy is given by $e_x=E[K_x]$ with $K_x=\\lfloor{T_x}\\rfloor$."),
  answer("The complete life expectancy refers to the expected value of the lifetime.", 
         message = "This statement is true. Recall that complete life expectancy is given by $\\mathring{e}_x=E[T_x]$."),
  answer("The curtate lifetime is always larger or equal to the exact lifetime.", message = "This statement is false. The curtate lifetime is always smaller or equal to the exact lifetime. This is because the integer part of the lifetime is always smaller or equal to the exact lifetime." , correct = TRUE),
  answer("The curtate life expectancy is always smaller or equal to the complete life expectancy.",
         message = "This statement is true. Recall that $\\lfloor{x}\\rfloor\\leq x$ therefore $e_x=E[K_x]=E[\\lfloor{T_x}\\rfloor]\\leq E[T_x] = \\mathring{e}_x$ "),
  allow_retry = TRUE
)
```
